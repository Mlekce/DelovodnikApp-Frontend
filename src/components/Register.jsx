...
export default function Register() {
  ...
  function posaljiPodatke(event) {
    ...
    if (!passwordTest) {
      setPoruka("Lozinke se ne slazu ili ne ispunjavaju kompleksnost!")
      return false
    }
    else if (!obradjenEmail) {
      setPoruka("Unesite validnu eMail adresu!")
      return false
    }
    else {
  ...
  return (
    <div className="flex h-screen flex-col justify-center px-6 py-12 lg:px-8" id="register">
      <div className="bg-white border border-gray-200 sm:mx-auto sm:w-full sm:max-w-md py-6 px-6 rounded-2xl shadow-xl">
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={posaljiPodatke}>
            <div>
              <label htmlFor="ime" className="block text-sm/6 font-medium text-gray-900">Ime i prezime</label>
              <div className="mt-2">
                <input type="text" name="ime" id="ime" autoComplete="ime" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
              </div>
            </div>
            ...
            <div>
              <label htmlFor="sluzba" className="block text-sm/6 font-medium text-gray-900">Sluzba</label>
              <div className="mt-2">
                <input type="text" name="sluzba" id="sluzba" autoComplete="sluzba" required className="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
              </div>
            </div>
